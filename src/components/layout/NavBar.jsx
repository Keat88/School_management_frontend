...
// Fallback page title derived from the current path, used when no
// explicit `title` prop is passed in (e.g. "/students" -> "Students").
...
function Navbar({ title, notificationCount = 0 }) {
  ...
  const badgeStyle = roleBadgeStyles[role] || "bg-gray-100 text-gray-600 ring-1 ring-inset ring-gray-200";
